...
export interface OracleConfig {
  ...
  pair: string;
  type: 'chainlink' | 'custom' | 'ethereum-universal';
...
export const ORACLE_MAP: Record<string, OracleConfig> = {
  ...
  'base:yoETH':  { address: '0x6E879d0CcC85085A709eBf5539224f53d0D396B0', pair: 'yoETH/ETH', type: 'custom', queryId: 6811220, decimals: 6, chainSlug: 'base', chainId: 8453 },
  ...
  'ethereum:ezETH':  { address: '0x74a09653A083691711cF8215a6ab074BB4e99ef5', pair: 'ezETH/ETH', type: 'ethereum-universal', topic0: '0x4e2ca0515ed1aef1395f66b5303bb5d6f1bf9d61a353fa53f73f8ac9973fa9f6', chainSlug: 'ethereum', chainId: 1 },
  ...
  // ── Polygon ── (Chainlink AnswerUpdated)
  'polygon:wstETH': { address: '0x1Dc2444b54945064c131145cD6b8701e3454C63a', pair: 'wstETH/ETH', type: 'chainlink', chainSlug: 'polygon', chainId: 137 },

  // ── Arbitrum ── (Chainlink AnswerUpdated)
...
export function getOracleForCollateral(symbol: string, chainSlug?: string): OracleConfig | null {
  ...
  // Fallback: find any chain match (backwards compat)
  for (const [key, config] of Object.entries(ORACLE_MAP)) {
    if (key.endsWith(`:${symbol}`)) return config;
  }
